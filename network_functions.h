/* 
    ...
    as long as use compile your main.c with network_functions.o (or network_functions_MAC.o).

    You are free to use any of the functions in this file for the final hand-in of your assignment,
    EXCEPT for the functions with _ans suffix.
*/
...
// [PEER_PORTS] is MAX_PEER_NUM * 4 byte BINARY data of peer ports.                   (See torrent_functions.h)
